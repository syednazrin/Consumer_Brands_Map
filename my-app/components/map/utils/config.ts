...
// Mapbox access token
export const MAPBOX_TOKEN = process.env.NEXT_PUBLIC_MAPBOX_TOKEN || 'pk.eyJ1IjoibXNoYW1pIiwiYSI6ImNtMGljY28zMzBqZGsycXF4MGppdmE0bWUifQ.nWArfpCw78mToZi2cN-e8w';

// Map initial settings
export const MAP_CONFIG = {
  style: 'mapbox://styles/mapbox/light-v11',
  center: [101.6869, 3.1390] as [number, number], // Malaysia center
  zoom: 6,
};

// Categories with Distribution Centers
export const DC_CATEGORIES = ['99 SpeedMart', 'Food and Beverages', 'MR DIY + MR TOY'];
...
export const CATEGORY_FILE_MAP: Record<string, string[]> = {
...
// DC file paths
export const DC_FILE_PATHS: Record<string, string> = {
  '99 SpeedMart': '/api/data/99 SpeedMart/DC/99speedmart-distribution-centers.json',
  'Food and Beverages': '/api/data/Food and Beverages/DC/oriental_kopi_distribution_centers.json',
  'MR DIY + MR TOY': '/api/data/MR DIY + MR TOY/DC/mr_diy_distribution_centers.json'
};
...
export const BRAND_COLORS: Record<string, string> = {
  ...
  // Department Stores
  'Parkson': '#00BCD4', // Cyan/Teal (distinct from Aeon's magenta)
  'Aeon': '#A0008E', // Magenta
  'AEON': '#A0008E',
...
export function getBrandFromFilename(filename: string): string {
...
export const LAYER_ORDER = [
  ...
  'dc-markers' // DC markers on top so they're always visible
];
